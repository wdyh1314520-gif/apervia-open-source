...
def _auth_identity_admin_html() -> str:
    return r'''<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Apervia 管理后台</title>
<style>
...
def auth_identity_admin_page():
    ...
    return _admin_html_response(_auth_identity_admin_html())
